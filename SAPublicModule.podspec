...
Pod::Spec.new do |s|
  ...
  s.subspec 'SACustomAlertView' do |ss|
  ss.source_files = 'SAPublicModule/SAPublicModule/SACustomAlertView/*.{h,m}'
  ss.resources = ['SAPublicModule/SAPublicModule/SACustomAlertView/*.png',]
  end
